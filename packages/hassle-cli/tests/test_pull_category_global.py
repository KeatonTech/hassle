...
def test_pull_creates_new_category_file_with_category_global(
    ...
    placed = git_repo / "automations" / "hvac.py"
...
def test_pull_refresh_preserves_existing_category_global_line(
    ...
    before = (git_repo / "automations" / "hvac.py").read_text(encoding="utf-8")
    ...
    after = (git_repo / "automations" / "hvac.py").read_text(encoding="utf-8")
