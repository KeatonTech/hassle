...
NAME_TO_CASES: dict[str, list[str]] = {
    ...
    "group_event": ["group_helper_declarations"],
    "group_fan": ["group_helper_declarations"],
    "group_light": ["group_helper_declarations"],
    "group_lock": ["group_helper_declarations"],
    "group_media_player": ["group_helper_declarations"],
    "group_notify": ["group_helper_declarations"],
    "group_sensor": ["group_helper_declarations"],
    "group_switch": ["group_helper_declarations"],
    "group_valve": ["group_helper_declarations"],
    # recording verbs
