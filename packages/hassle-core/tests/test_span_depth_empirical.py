"""Empirical verification of the `capture_span(depth=2)` claim in docs/m1-internal-api.md §2.
...
docs/m1-internal-api.md §2 asserts, independent of any one construct's
