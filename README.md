...
Source files are named after your HA categories (`hassle pull` creates them on
demand; uncategorized objects land in `misc.py`), and subdirectories work too —
the bundle loader recurses.
...
- The IR/compiler/decompiler round-trip is the most heavily tested part of the
  ...
  decompiler's coverage-hardening passes (`docs/ha-api-notes.md` §19-21).
